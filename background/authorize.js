...
var CLIENT_ID = '859156245132-lq7pmvs7metffnt6q6k8lsm230smmjk6.apps.googleusercontent.com';
...
it seems to be "aud".
*/
function validate(redirectURL, token) {
  const accessToken = token ? token : extractAccessToken(redirectURL);
  if (!accessToken) {
...
function getAccessToken() {
  return authorize().then(validate).then(token => {
